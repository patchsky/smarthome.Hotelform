    ...
    <div class="cont" id="loginbox">
		 <div class="demo">
			  <div class="login" id="loginbox">
				  <div class="login__check"><img src="" alt="Logo" style="text-align: center; display: block;"/></div>
			      <div class="login__form">
			        <div class="login__row">
			          <svg class="login__icon name svg-icon" viewBox="0 0 20 20">
			            <path d="M0,20 a10,8 0 0,1 20,0z M10,0 a4,4 0 0,1 0,8 a4,4 0 0,1 0,-8" />
			          </svg>
			          <input type="text" class="login__input name" placeholder="Username" id="usename" value="${pd.PHONE}" readonly="readonly" />
			        </div>
			        <div class="login__row">
			          <svg class="login__icon pass svg-icon" viewBox="0 0 20 20">
			            <path d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0" />
			          </svg>
			          <input type="password" class="login__input pass" placeholder="Password" id="password" value="${pd.PWD}" readonly="readonly"/>
			        </div>
			        <button type="button" class="login__submit" onclick="check();">Sign in</button>
...
<script type="text/javascript">
	...
	function check() {
		...
		if ($("#usename").val() == "") {
			...
			$.ajax({
				type: "POST",
				url: '<%=basePath%>weixin/login_login2.do?',
		    	data: {'PHONE' : loginname,'PWD' : password},
				dataType:'json',
				cache: false,
