...
img1.src="../"+o.value;
	...
	<form action="modelinfo/goAdd.do" name="Form" id="Form" method="post">
		<input type="hidden" name="MODEL_ID" id="MODEL_ID" value="${pd.MODEL_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover" style="margin-top: 20%" >
			<tr >
