...
<body>
	<form action="hostdevice/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<table style="width:95%;" >
			...
			<tr>
				<td style="text-align: center;">
					<a class="btn btn-mini btn-primary" onclick="save();">导入设备</a>
					<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/hostdevice/downExcel.do'">下载设备模版</a>
