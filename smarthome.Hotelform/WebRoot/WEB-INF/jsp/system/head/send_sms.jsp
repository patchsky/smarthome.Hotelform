		...
		<table style="width:99%;">
			<tr>
				<td style="margin-top:0px;">
					 <div style="float: left;"><textarea name="PHONE" id="PHONE" rows="1" cols="50" style="width:580px;height:20px; resize: none" readonly="readonly"  >${pd.PHONE}</textarea></div>
					 <!-- <div style="float: right;"><a class='btn btn-mini btn-info' title="编辑手机号" onclick="dialog_open();"><i class='icon-edit'></i></a></div> -->
				</td>
			</tr>
			<tr>
				<td id="nr">
					 <textarea name="CONTENT" id="CONTENT" readonly="readonly" style="width:98%;height:165px;resize: none" rows="7" cols="50" title="第三方短信内容需要提交官方审核,否则发送失败!">您的登录的账户为：${pd.username}密码为：${pd.pwds}</textarea>
				</td>
			</tr>
			<tr>
