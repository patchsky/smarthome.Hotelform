...
<body >
	...
	<div class="navbar-inner" >
		<div class="container-fluid">
			<a class="brand"><small><!-- <i class="icon-leaf"> --></i>
					${pd.SYSNAME}</small> </a>
			...
			<ul class="nav ace-nav pull-right">
				...
				<li class="light-blue user-profile" style="width: 100%"><a
					class="user-menu dropdown-toggle" href="javascript:;"
					data-toggle="dropdown"> <!-- <img alt="FH" src="static/avatars/user.jpg" class="nav-user-photo" /> -->
						<span id="user_info"> </span> <i class="icon-caret-down"></i>
				</a>
					<ul id="user_menu"
						class="pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
						<li id="modifiedDate"><c:if test="${user.USERNAME=='admin'}"><a onclick="editUserH();" style="cursor: pointer;"><i
								class="icon-user"></i> 修改资料</a></c:if></li>
						<li id="systemset"><a onclick="editSys();"
							style="cursor: pointer;"><i class="icon-cog"></i> 系统设置</a></li>
						<li id="productCode"><a onclick="productCode();"
							style="cursor: pointer;"><i class="icon-cogs"></i> 代码生成</a></li>
						<li class="divider"></li>
