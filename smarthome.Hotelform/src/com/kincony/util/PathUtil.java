...
public class PathUtil {
	 ...
	 * 获取classpath2
	 */
	public static String getClassResourcess(){
		String path =  (String.valueOf(Thread.currentThread().getContextClassLoader().getResource(""))).replaceAll("file:/", "").replaceAll("%20", " ").replace(".metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/", "").trim();	
		if(path.indexOf(":") != 1){
			path = File.separator + path;
		}
		return path;
