...
public class SmsUtil {
	...
	public static void main(String [] args) throws UnsupportedEncodingException {
		String sendMsg = SendMsgUtil.sendMsg("15105873889", URLEncoder.encode("您的验证码是：1111。请不要把验证码泄露给其他人。","utf-8"));
 	...
 	public static void sendSms1(String mobile,String code) throws UnsupportedEncodingException{
	  ...
	  /*  String account = "", password = "";
		...
		try {
 		...
 		/*System.err.println(mobile+" **** "+URLEncoder.encode(code,"utf-8"));*/
