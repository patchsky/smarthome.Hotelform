package com.kincony.controller.system.head;
...
import com.kincony.util.SmsUtil;
import com.kincony.util.Tools;
import com.kincony.util.Watermark;
import com.kincony.util.mail.SimpleMailSender;
...
public class HeadController extends BaseController {
	...
	public ModelAndView goSendSms() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		System.err.println(pd.getString("pwd"));
		String str2= pd.getString("pwd").replaceAll(" ","+");
		pd.put("pwds", AES.decrypt(str2));
	...
	@ResponseBody
	public Object sendSms() throws UnsupportedEncodingException{
		PageData pd = new PageData();
		pd = this.getPageData();
		Map<String,Object> map = new HashMap<String,Object>();
		String msg = "ok";		//发送状态
		...
		String s = "232323232,101";
		
		String sendMsg = SendMsgUtil.sendMsg(PHONEs, CONTENT);
		...
		if (split[1].equals("0")) {
			msg = "ok";
		}else if (split[1].equals("101")) {
			msg = "101";
		} else if (split[1].equals("103")) {
			msg = "103";
		} else if (split[1].equals("108")) {
			msg = "108";
		} else if (split[1].equals("109")) {
			msg = "109";
		}else{
			msg = "error";
		}
