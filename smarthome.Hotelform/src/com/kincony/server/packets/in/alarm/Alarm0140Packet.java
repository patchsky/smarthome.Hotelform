 ...
 *
 */
public class Alarm0140Packet extends AlarmPacket{
	private static Logger logger = LoggerFactory.getLogger(Alarm0140Packet.class);
	private int frameStatus;
	
	public Alarm0140Packet(ChannelBuffer buf) throws PacketParseException {
		super(buf);
	}
