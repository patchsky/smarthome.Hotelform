 ...
 *
 */
public class Alarm0150Packet extends AlarmPacket{
	private static Logger logger = LoggerFactory.getLogger(Alarm0150Packet.class);
	private int frameStatus;
	
	public Alarm0150Packet(ChannelBuffer buf) throws PacketParseException {
		super(buf);
	}
