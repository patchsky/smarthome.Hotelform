package com.kincony.service.system.user;
...
public class UserService {
	...
	*/
	public PageData findByPhone(PageData pd)throws Exception{
		return (PageData)dao.findForObject("UserXMapper.findByPhone", pd);
	}
	...
	*/
	public List<PageData> getAll(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("UserXMapper.getAll", pd);
	}
	...
	* 保存用户IP
	*/
	public void updateQrCode(Map<String, Object> map)throws Exception{
		dao.update("UserXMapper.updateQrCode", map);
	}
